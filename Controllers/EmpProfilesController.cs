...
using PhaseEndWeb.Models;

namespace PhaseEndWeb.Controllers
{
    ...
    public class EmpProfilesController : ControllerBase
    {
        ...
        public EmpProfilesController(PhaseEndDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<EmpProfile>> PostEmpProfile(EmpProfile empProfile)
        {
          if (_context.EmpProfiles == null)
          {
              return Problem("Entity set 'PhaseEndDbContext.EmpProfiles'  is null.");
          }
